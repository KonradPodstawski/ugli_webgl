...
impl BasicEngine<Rc<RefCell<Self>>> for Engine {
    fn init(&mut self, _rc: Rc<RefCell<Self>>) {
        ...
        self.context.viewport(-500, -150, w as i32, h as i32);
...
pub fn init() {
    ...
    context.buffer_data_1(gl::ARRAY_BUFFER, Some(&textureCoordinates), gl::STATIC_DRAW);
